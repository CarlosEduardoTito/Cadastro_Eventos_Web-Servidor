...
<?php endif; ?>
<form action="/trabalho1/public/index.php?action=criar_evento" method="POST" class="form-container">
...
<p class="form-link">
    <a href="/trabalho1/public/index.php?action=menu">Voltar para o Menu</a>
</p>
